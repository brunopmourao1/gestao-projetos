...
|---|---|---|---|---|
| R1 | Dados técnicos incompletos travarem a transição para "Operação Concluída" e gerar frustração/gargalo no time | Média | Médio | Mensagens de erro claras indicando exatamente quais campos faltam (`PARAMETROS_INCOMPLETOS`); considerar salvar rascunho parcial sem bloquear edição |
...
| I2 | Definir se haverá autenticação/controle de acesso na v1 ou se fica para uma v2 | Aberto |
